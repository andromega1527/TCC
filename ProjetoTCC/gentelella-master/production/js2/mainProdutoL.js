var btnElement = document.querySelector('button#editar');
var sla = [];
var slaP = [];
var contar = 0;
...
function linkar(item, indice) {
	item.onclick = function() {
		form.setAttribute('action', 'Res_Delet_ProdutoL.php?cod=' + sla[indice] + '&codP=' + sla[indice]);
	}
}
